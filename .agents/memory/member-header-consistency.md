...
Use the Debaters member user bar as the structural source of truth for every authenticated member page. Role changes should update only the role label and artwork; the role badge keeps the established Website Admin width and shared dark-green color.
