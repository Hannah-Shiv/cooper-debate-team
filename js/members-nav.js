...
(function () {
  ...
  var ITEMS = [
    ...
    {
      cls: 'dn-p6', href: 'awards.html', label: 'Awards',
      active: PAGE === 'awards',
      /* trophy */
      icon: '<polyline points="14.5 17 14.5 22 9.5 22 9.5 17"/><path d="M17 22H7"/><path d="M5 3H3v6a5 5 0 0 0 10 0V3"/><path d="M19 3h2v6a5 5 0 0 1-10 0V3"/><line x1="12" y1="13" x2="12" y2="17"/>'
    }
  ];
