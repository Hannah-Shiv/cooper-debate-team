(function () {
  ...
  function renderRubric() {
    ...
    root.querySelector(".eval-meter i").style.width = `${progress}%`;
    root.querySelector(".eval-meter span").textContent = `${progress}%`;
  ...
  function rubricMarkup() {
    return `<div class="eval-meter" aria-label="Evaluation progress"><i></i><span>0%</span></div>${RUBRIC.map((category, index) => {
