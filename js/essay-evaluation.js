(function () {
  ...
  function renderRubric() {
    ...
    dialog.querySelector(".eval-header-score").textContent = `${completed} of 7 categories scored. ${total()} / 35 points`;
