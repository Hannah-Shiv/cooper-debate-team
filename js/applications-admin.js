          ...
          if (key === "essay") {
            const driveDocument = googleDriveDocument(item.answers?.requiredEssay);
             ...
             entry.className = "essay-entry-shell";
               entry.innerHTML = `<section class="essay-entry-document"><header class="essay-entry-bar"><div><span class="essay-entry-kicker">Required essay / document</span><strong>Submitted document</strong></div><div class="essay-entry-tools"><a class="essay-source-link" target="_blank" rel="noopener noreferrer">Open source ↗</a><button type="button" class="essay-fullscreen-button">Full screen</button></div></header><div class="essay-preview-body"></div></section><aside class="essay-entry-reference"><header class="essay-reference-head"><div class="essay-reference-launch"><img class="essay-head-icon" src="images/application-review/evaluation-workspace-icon.png" alt=""><div class="essay-reference-launch-content"></div></div><span class="essay-reference-head-divider" aria-hidden="true"></span><div class="essay-reference-heading"><img class="essay-head-icon" src="images/application-review/evaluation-reference-icon.png" alt=""><div class="essay-reference-heading-copy"><span class="essay-entry-kicker">Evaluation reference</span><h2>Rubric Quick Reference</h2><p>Seven categories · 35 points possible</p></div></div></header><div class="essay-reference-list"></div></aside>`;
