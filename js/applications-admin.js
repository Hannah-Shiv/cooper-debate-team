...
(function () {
  ...
  function renderDetail() {
    ...
    $("detail").innerHTML = `<div class="detail-content">
      <header class="detail-heading"><div class="detail-title-row"><h2>${icon("person", "applicant-pill-icon")}${escapeHtml([student.firstName, student.lastName].filter(Boolean).join(" ") || "Unnamed applicant")}</h2><div class="detail-inline-status badges">${statusBadge(decision)}${item.hidden === true ? hiddenBadge() : ""}</div></div>${isFinalReviewer() ? '<div class="detail-report-actions" aria-label="Global applicant reports"><button type="button" class="report-launch report-launch-scores" id="essay-scores-report" aria-haspopup="dialog"><span class="report-launch-icon" aria-hidden="true"><img src="attached_assets/image_1789562371481.png" alt=""></span><span class="report-launch-label">Essay Scores</span><span class="report-launch-arrow" aria-hidden="true">›</span></button><button type="button" class="report-launch report-launch-decisions" id="decision-status-report" aria-haspopup="dialog"><span class="report-launch-icon" aria-hidden="true"><img src="attached_assets/image_1789562394607.png" alt=""></span><span class="report-launch-label">Decision Status</span><span class="report-launch-arrow" aria-hidden="true">›</span></button></div>' : ""}</header>
