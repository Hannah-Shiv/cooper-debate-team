...
(function () {
  ...
  function renderDetail() {
    ...
    $("detail").innerHTML = `<div class="detail-content">
      <header class="detail-heading"><div class="detail-title-row"><h2>${escapeHtml([student.firstName, student.lastName].filter(Boolean).join(" ") || "Unnamed applicant")}</h2><div class="detail-inline-status badges">${statusBadge(decision)}${item.hidden === true ? hiddenBadge() : ""}</div></div>${isFinalReviewer() ? '<div class="detail-report-actions" aria-label="Global applicant reports"><button type="button" class="report-launch report-launch-scores" id="essay-scores-report" aria-haspopup="dialog"><span class="report-launch-icon" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="M6 2.75h8.2L19 7.55v13.7H6z"/><path d="M14 2.75v5h5M9 11h2m2 0h2m-6 3h2m2 0h2m-6 3h2m2 0h2"/></svg></span><span class="report-launch-label">Essay Scores</span><span class="report-launch-arrow" aria-hidden="true">›</span></button><button type="button" class="report-launch report-launch-decisions" id="decision-status-report" aria-haspopup="dialog"><span class="report-launch-icon" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="M12 3a9 9 0 1 0 9 9h-9z"/><path d="M15 3.5A7.5 7.5 0 0 1 20.5 9H15z"/></svg></span><span class="report-launch-label">Decision Status</span><span class="report-launch-arrow" aria-hidden="true">›</span></button></div>' : ""}</header>
