...
(function () {
  ...
  function createDialog() {
    ...
    wrapper.innerHTML = [
      ...
      '        <span class="fcps-application-auth__continue-rays" aria-hidden="true"><i></i><i></i><i></i></span>',
      '        <svg class="fcps-application-auth__continue-icon" viewBox="0 0 32 38" aria-hidden="true"><path fill="currentColor" d="M4 1h16l8 8v27a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1Zm15 2v8h7M8 16h15v2H8Zm0 5h15v2H8Zm0 5h11v2H8Z"/><path fill="#efad20" d="M7 6h8v6H7z"/></svg>',
      '        <span>Open the Team Application</span>',
      '        <span class="fcps-application-auth__continue-arrow" aria-hidden="true">⟶</span>',
      '        <span class="fcps-application-auth__continue-rays fcps-application-auth__continue-rays--right" aria-hidden="true"><i></i><i></i><i></i></span>',
      '      </a>',
      '    </div>',
      '  </div>',
      '</dialog>'
