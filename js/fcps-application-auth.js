...
(function () {
  ...
  function createDialog() {
    ...
    wrapper.innerHTML = [
      ...
      '        <img class="fcps-application-auth__continue-rays" src="images/application-rays-left.png" alt="" aria-hidden="true">',
      '        <img class="fcps-application-auth__continue-icon" src="images/application-document-icon.png" alt="" aria-hidden="true">',
      '        <span>Open the Team Application</span>',
      '        <span class="fcps-application-auth__continue-arrow" aria-hidden="true">⟶</span>',
      '        <img class="fcps-application-auth__continue-rays fcps-application-auth__continue-rays--right" src="images/application-rays-right.png" alt="" aria-hidden="true">',
      '      </a>',
      '    </div>',
      '  </div>',
      '</dialog>'
